            ...
            <div className="max-w-xl mx-auto">
                <div className="p-5">
                    ...
                    <div className="leading-relaxed">
                        Your privacy is important to us. It is ShipFast's policy to respect your privacy regarding any information we may collect from you across our website, and other sites we own and operate.<br />
                        <br />
                        ...
                        <br />
                        You can sign up with your Google account so your ShipFast's account username will be prefilled with your name and your public profile picture.<br />
                        <br />
                        ...
                        <br />
                        We act in the capacity of a data controller and a data processor with regard to the personal data processed through ShipFast and the services in terms of the applicable data protection laws, including the EU General Data Protection Regulation (GDPR).<br />
                        <br />
