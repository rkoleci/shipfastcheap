        ...
        <section className="w-full bg-base-400 flex justify-center">
            <div className="bg-base-400 flex flex-col lg:flex-row flex-between gap-8 max-w-7xl px-8 py-16">
                <div className="flex flex-col   text-left basis-1/2">
                    ...
                    <div className="text-accent-main text-lg-content/80">Have another question? Contact me on<a className="link text-lg-content" target="_blank" href="https://twitter.com/marc_louvion">Twitter</a> or by<a href="mailto:marc@shipfa.st" target="_blank" className="link text-lg-content">email</a>.</div></div>
                ...
                <div className=" basis-1/2">
                    <div className="collapse collapse-plus bg-base-400  border-t border-t-[1px] border-gray-800 rounded-none py-1">
                        ...
                        <div className="collapse-content px-0">
                           <p className="leading-6   font-medium text-accent-main">1/ The NextJS starter with all the boilerplate code you need to run an online business: a payment system, a database, login, a blog, UI components, and much more. The repo is available in: - Javascript and Typescript - /app router and /pages router.</p>
                        </div>
                    </div>
                    <div className="collapse collapse-plus bg-base-400  border-t border-t-[1px] border-gray-800 rounded-none py-1">
