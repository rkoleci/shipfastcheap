...
import image from '../../../../../public/test-triple.webp'
        ...
        <div>
            ...
            <ul>
                <div className="text-3xl text-accent-main font-bold  flex flex-row justify-start items-center gap-1 mb-10">
                    ...
                    <li>
                        <Link href="/docs/components/testimonial-triple" className="mb-8">Testimonial Triple</Link>
                    </li>
                </div>
            </ul>
            ...
            <CopyBlock
                language={'tsx'}
                text={`import TestimonialTriple from "@/components/testimonial-triple";                `}
                showLineNumbers
                theme={dracula}
                codeBlock
            />
