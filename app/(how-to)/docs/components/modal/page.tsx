...
import image from '../../../../../public/modal.webp'
        ...
        <div>
            ...
            <ul>
                <div className="text-3xl text-accent-main font-bold  flex flex-row justify-start items-center gap-1 mb-10">
                    ...
                    <li>
                        <Link href="/docs/components/modal" className="mb-8">Modal</Link>
                    </li>
                </div>
            </ul>

            <div className="docs-content">An animated popup window for explainers, lead generation, forms, etc.
