        ...
        <div>
            ...
            <ul>
                <div className="text-3xl text-accent-main font-bold  flex flex-row justify-start items-center gap-1 mb-10">
                    ...
                    <li>
                        <Link href="/docs/components/better-icon" className="mb-8">Better Icon</Link>
                    </li>
                </div>
            </ul>

            <div className="docs-content mb-4">A better way to display simple SVG icons!

            </div>

            <div className="mb-4"> <BetterIcon />
</div>
