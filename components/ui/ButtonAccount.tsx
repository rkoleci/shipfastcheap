    ...
    return (
        <div className="dropdown">
            <div tabIndex={0} role="button" className="btn m-1 bg-base-200">
                <Image width={25} height={25} src={shipfastAvatar} alt='username' className='rounded-full' />
                Marc Lou
                <span>
            ...
            <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                <li>
                    <Link href='/' className='flex justify-start gap-3'>
                        ...
                        <p className='text-accent-secondary font-medium leading-relaxed'>Billing</p>
                    </Link>
